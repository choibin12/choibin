...
public class MultiFor04 {
	...
	public static void main(String[] args) {
		int dan, i , j;
			for (j = 1; j <= 9; j+=3) {
				for (i=1; i<=9; i++) {
					for(dan = j+1; dan <= j+3; dan++) {//2~4 , 5~7 , 7~10
						if(dan==10)break;//10단이 안나오게
						System.out.print(dan+"*"+i+"="+dan*i+"\t");
					}
					System.out.println();//2~4*1하고 나올때 줄바꿈
				}
				System.out.println();//2~4*9 까지하고 줄바꿈
				
		}
	}

}
//i=j; i<j+3; i++ dan = 2; dan <= 9; dan++
//3중for 3개찍히면 돌아가고
/*
